...
const projects = [
  {
    ...
    technologies: ["JavaScript", "React", "Next.js", "Zustand", "Tailwind CSS"],
    highlights: [
    ...
    github: "https://github.com/amit/kanban-board",
    demo: "https://kanban-board-amit.vercel.app",
  },
  {
  ...
  return (
    <section id="projects" className="py-20 bg-background/50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeading title="Featured Projects" subtitle="A selection of my recent development work" />
